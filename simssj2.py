...
class Simulation(object):
    ...
    def integrate(self,trajectory):
        ...
        ##### FIN DATA
        global fh, sa, CTm, CRm, TFm, finnum
        ...
        finnum = self.FinsNumber # number
        #numfin = self.FinsChoice # number of fins
        
        #print "FH=",fh,sa,CTm,CRm,TFm, finnum
    ...
    def Cdrag (self,v,h):
        ...
        if finnum >= 1:
          ...
          Mu = 0.00001789 # kg/m.s            #print 'Rho,a',Rho,v,lflm,Mu,a
          ...
          cdfins = 2.*CF*(1.+2.*(TFm/lflm))*(4.*finnum*(AFP))/(3.141592*diam**2.)
          #print 'cdfins=',AFEP,AFP,diam,cdfins     
          #cdfins = 0.
        else:
          cdfins=0.
        ...
        #print 'cdfins:',cdfins,TFm,CF,lflm,AFP,finnum,diam

        #cdfins= 0. # MAY 18 turned off fins for now.
        ...
        cd = cd +cdfins
        # print 'cd,cdfins',finnum,cd,cdfins,'    mach,h',mach,h/1000. # TURN ON FOR TESTING    
        return cd
...
if __name__ == "__main__":
    ...
    for i in range(1,sim.numstages+1):
        ...
        sim.mach = float(raw_input("Mach: "))*1.
